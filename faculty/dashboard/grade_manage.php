        ...
        <body>
            ...
            <main class="table">
                <section class="table__header">
                    ...
                    <div class="button2"><a href="/sol/faculty/dashboard/add_activity.php?rec_ID=<?php echo $recID."&sub_ID=".$sub_ID; ?>" style="--clr:#1e9bff"><span>Add
                                Activity</span><i></i></a></div>
                    <div class="button3"><a href="/sol/faculty/dashboard/view_score.php" style="--clr:#39FF14"><span>View
                                Score</span><i></i></a></div>
